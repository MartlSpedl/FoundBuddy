        ...
        try {
            ...
            if (!apps.isEmpty()) {
                ...
                try {
                    ...
                    // The hardcoded key was removed here because it was leaked on GitHub.
                    // Instead, use the environment variable FIREBASE_CREDENTIALS_JSON in production.
                    String firebaseJson = System.getenv("FIREBASE_CREDENTIALS_JSON");
                    
                    if (firebaseJson == null || firebaseJson.isEmpty()) {
                        info.put("firestoreRest", "ERROR: FIREBASE_CREDENTIALS_JSON is missing");
